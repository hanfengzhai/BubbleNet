...
Then, execute the '.m' files to generate figures for the final results, either with [MATLAB(R)](https://www.mathworks.com/products/matlab.html) or [Octave](https://www.gnu.org/software/octave/index):
```bash
