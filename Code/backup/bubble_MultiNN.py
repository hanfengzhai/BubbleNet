...
class PhysicsInformedNN:
    ...
    def __init__(self, x, y, t, u, v, p, phil, layers):
        ...
        self.loss = tf.reduce_sum(tf.square(self.u_tf - self.u_pred)) + \
                    ...
                    tf.reduce_sum(tf.square(self.phil_tf - self.phil_pred)) # loss function
...
# ==============================================================================================    
    def predict_u(self, x_star, y_star, t_star):
        ...
        tf_dict = {self.x_tf_u: x_star, self.y_tf_u: y_star, self.t_tf_u: t_star}      
    ...
    def predict_v(self, x_star, y_star, t_star):
        ...
        tf_dict = {self.x_tf_v: x_star, self.y_tf_v: y_star, self.t_tf_v: t_star} 
...
if __name__ == "__main__": 
    ...
    N_train = 2.5*(100000000)
    
    layers = [3, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 1]
    
    # Load Data
    Xdata = scipy.io.loadmat('../Data/Xdata.mat')
