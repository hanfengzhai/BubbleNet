...
if __name__ == "__main__": 
    ...
    np.savetxt("u_pred_PhysNet_sys.txt", np.hstack(u_pred))
    np.savetxt("v_pred_PhysNet_sys.txt", np.hstack(v_pred))
    np.savetxt("p_pred_PhysNet_sys.txt", np.hstack(p_pred))
    np.savetxt("phil_pred_PhysNet_sys.txt", np.hstack(phil_pred))
    
    np.savetxt("u_error_PhysNet_sys.txt", np.hstack(error_u_abs))
    np.savetxt("v_error_PhysNet_sys.txt", np.hstack(error_v_abs))
    np.savetxt("p_error_PhysNet_sys.txt", np.hstack(error_p_abs))
    np.savetxt("phil_error_PhysNet_sys.txt", np.hstack(error_phil_abs))